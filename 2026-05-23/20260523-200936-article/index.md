...
![单个技能映射到 5 套框架的关系图，中心是 SKILL.md，五个箭头分别指向 MITRE ATT&CK、NIST CSF 2.0、MITRE ATLAS、D3FEND、NIST AI RMF](schematic-1.png)
...
![26 个安全域的技能数量柱状图，Cloud Security 60 排第一，Deception Technology 2 排最后，标注 480 万人才缺口数字](schematic-2.png)
...
![agentskills.io 三层架构示意，YAML 前端 → Markdown 工作流 → references/ 深度参考，标注 token 消耗（30 / 500-2000）](schematic-3.png)
...
![GARS-2026 调查 → 754 技能库 → Casky.ai Playground 的生态关系图](schematic-4.png)
